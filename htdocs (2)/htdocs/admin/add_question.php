...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("
                INSERT INTO quizzes (question_text, question_type, option_a, option_b, option_c, option_d,
...
<div class="admin-container">
    ...
    <h2>📝 Add New Question Component</h2>
    ...
    <form method="POST" id="question-form">
        <div class="form-group">
            ...
            <textarea name="question_text" rows="3" required placeholder="Enter the evaluation question query statement..."></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="question_type" id="question-type" onchange="toggleOptions()">
                ...
                <option value="scale">Scale Matrix (1-5)</option>
            </select>
        </div>

        <div id="scale-info" class="scale-info hidden">
        ...
        <div id="options-section">
            <div class="options-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="option_a" id="option_a" placeholder="Label A">
                    <label style="margin-top: 10px;">Weight Factor A</label>
                    <input type="number" name="weight_a" value="1" id="weight_a">
                </div>
                <div class="form-group">
                    <label>Option B Label</label>
                    <input type="text" name="option_b" id="option_b" placeholder="Label B">
                    <label style="margin-top: 10px;">Weight Factor B</label>
                    <input type="number" name="weight_b" value="2" id="weight_b">
                </div>
            </div>
            <div class="options-grid">
                <div class="form-group">
                    <label>Option C Label</label>
                    <input type="text" name="option_c" id="option_c" placeholder="Label C">
                    <label style="margin-top: 10px;">Weight Factor C</label>
                    <input type="number" name="weight_c" value="3" id="weight_c">
                </div>
                <div class="form-group">
                    <label>Option D Label</label>
                    <input type="text" name="option_d" id="option_d" placeholder="Label D">
                    <label style="margin-top: 10px;">Weight Factor D</label>
                    <input type="number" name="weight_d" value="4" id="weight_d">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="category" placeholder="e.g., Interest, Technical, Role">
        </div>

        <div class="form-group">
            <label>Sequence Matrix Order</label>
            <input type="number" name="question_order" value="0">
        </div>

        <div class="form-actions-row">
            <button type="submit" class="btn btn-pastel">Add Question</button>
...
function toggleOptions() {
    ...
    if (type === 'scale') {
        ...
        // Sanitize field data values if scale is selected
...
// Ensure interface state correctly maps data on synchronous initialization
